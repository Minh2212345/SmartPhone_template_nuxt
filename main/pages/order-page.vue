  ...
  <div class="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div class="flex flex-1 justify-center">
        ...
        <div class="bg-white shadow-md p-4 m-2 rounded-3xl flex flex-col justify-center" style="height: 50vh">
          <div class="flex flex-col space-y-2">
            ...
            <button
              @click="handleLogout"
              class="px-4 py-2 text-gray-600 hover:text-red-600 focus:outline-none text-left flex items-center"
            >
              <i class="las la-sign-out-alt mr-2 text-lg"></i>
              Đăng xuất
            </button>
          </div>
        </div>
    ...
    <div v-else class="flex items-center justify-center min-h-screen">
      <div class="bg-white p-6 rounded-lg shadow-lg text-center">
        <h2 class="text-2xl font-semibold text-gray-800 mb-4">Vui lòng đăng nhập</h2>
  ...
  methods: {
    ...
    async handleLogout() {
      try {
        ...
        // await axios.post('http://localhost:8080/tai-khoan/dang-xuat');
